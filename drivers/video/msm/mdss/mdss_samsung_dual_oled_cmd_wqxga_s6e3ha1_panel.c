...
static struct  panel_hrev panel_supp_cdp[]= {
	{"samsung amoled wqxga command mode dsi S6E3HA1 right panel", PANEL_WQXGA_OCTA_S6E3HA1_CMD},
	{"samsung amoled wqxga command mode dsi S6E3HA1 left panel", PANEL_WQXGA_OCTA_S6E3HA1_CMD},
	{NULL}
};
...
static int mdss_dsi_panel_dimming_init(struct mdss_panel_data *pdata)
{
	...
	switch (msd.panel) {
		case PANEL_WQXGA_OCTA_S6E3HA1_CMD:
			msd.sdimconf = smart_S6E3HA1_get_conf();
			break;
	}
